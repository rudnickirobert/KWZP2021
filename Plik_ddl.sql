...
CREATE TABLE DZ_Status_zamowienia(
	...
	Id_rodzaj_statusu_zam int NOT NULL FOREIGN KEY REFERENCES DZ_Rodzaj_statusu_zamowienia(Id_rodzaj_statusu_zam), 
	);
CREATE TABLE DZ_Zamowienie_zewn(
	Id_zamowienia_zewn int IDENTITY (1,1) NOT NULL PRIMARY KEY, 
	Id_pracownika int NOT NULL FOREIGN KEY REFERENCES DZ_Pracownik(Id_pracownika),
...
CREATE TABLE DZ_Szczegoly_zam_maszyn(
	...
	Id_zamowienia_zewn int NOT NULL FOREIGN KEY REFERENCES DZ_Zamowienie_zewn(Id_zamowienia_zewn), 
...
CREATE TABLE DZ_Po_szczegoly_zam_produkt(
	Id_szczegoly_zam_klienta int NOT NULL FOREIGN KEY REFERENCES DZ_Szczegoly_zamowienia_klienta(Id_szczegoly_zam_klienta),
...
CREATE TABLE DM_Szczegoly_wydania_materialu(
	Id_wydanie_materialu_dla_produkcji int NOT NULL FOREIGN KEY REFERENCES DM_Wydanie_materialu_dla_produkcji(Id_wydanie_materialu_dla_produkcji), 
    Id_materialu int NOT NULL FOREIGN KEY REFERENCES DM_Material(Id_materialu),
	Ilosc int NOT NULL
);
CREATE TABLE DM_Szczegoly_magazynu_gotowych_produktow(
	Id_magazynu_gotowych_produktow int NOT NULL FOREIGN KEY REFERENCES DM_Magazyn_gotowych_produktow(Id_magazynu_gotowych_produktow), 
...
CREATE TABLE DP_Wydruk(
	...
	Estymowany_czas int NOT NULL,
	Estymowana_masa nvarchar(10) NOT NULL,
	Id_pliku int NOT NULL FOREIGN KEY REFERENCES DZ_Plik(Id_pliku)
);
...
CREATE TABLE DP_Po_wydr_proc(
	...
	Id_wydruk int NOT NULL FOREIGN KEY REFERENCES DP_Wydruk(Id_wydruk), 
	Id_proces_technologiczny int NOT NULL FOREIGN KEY REFERENCES DP_Proces_technologiczny(Id_proces_technologiczny),
...
CREATE TABLE DP_Po_proc_czynnosc(
	...
	Id_rodzaj_czynnosci int NOT NULL FOREIGN KEY REFERENCES DP_Rodzaj_czynnosci(Id_rodzaj_czynnosci),
	Id_proces_technologiczny int NOT NULL FOREIGN KEY REFERENCES DP_Proces_technologiczny(Id_proces_technologiczny),
	Czas_zamierzony datetime NOT NULL
);

CREATE TABLE DP_Po_narzedzia_czynnosc(
	Id_po_proc_czynnosci int NOT NULL FOREIGN KEY REFERENCES DP_Po_proc_czynnosc(Id_po_proc_czynnosci), 
	Id_narzedzia int NOT NULL FOREIGN KEY REFERENCES DM_Narzedzie(Id_narzedzia)
);
...
CREATE TABLE DP_prod_material(
	Id_proces_produkcyjny int NOT NULL FOREIGN KEY REFERENCES DP_Proces_produkcyjny(Id_proces_produkcyjny),  
	Id_materialu int NOT NULL FOREIGN KEY REFERENCES DM_Material(Id_materialu),
	Ilosc_zuzytego_materialu float NOT NULL
);
...
CREATE TABLE DP_Zuzyta_maszyna(
	...
	Id_maszyny  int NOT NULL FOREIGN KEY REFERENCES DP_Maszyna(Id_maszyny), 
	Data_zuzycia_maszyny date NOT NULL,
	Uwagi nvarchar(30) NULL
);
...
CREATE TABLE DP_Czynnosc_w_ramach_obslugi_serw_wew(
	...
	Id_nazwa_obslugi int NOT NULL FOREIGN KEY REFERENCES DP_Nazwa_obslugi(Id_nazwa_obslugi),
	Id_czynnosc int NOT NULL FOREIGN KEY REFERENCES DP_Czynnosc(Id_Czynnosc)
);
CREATE TABLE DP_Co_ile_obsluga(
	Id_co_ile_obsluga int IDENTITY(1,1) NOT NULL PRIMARY KEY, 
	Co_ile_obsluga int NOT NULL
);
CREATE TABLE DP_Obsluga(
	Id_obslugi int IDENTITY(1,1) NOT NULL PRIMARY KEY, 
	Id_nazwa_obslugi int NOT NULL FOREIGN KEY REFERENCES DP_Nazwa_obslugi(Id_nazwa_obslugi),
	Id_rodzaj_maszyny int NOT NULL FOREIGN KEY REFERENCES DP_Rodzaj_maszyny(Id_rodzaj_maszyny),
	Id_co_ile_obsluga int NOT NULL FOREIGN KEY REFERENCES DP_Co_ile_obsluga(Id_co_ile_obsluga)
);
...
CREATE TABLE DP_Serwis_zewnetrzny(
	...
	Id_firma_serwisowa int NOT NULL FOREIGN KEY REFERENCES DP_Firma_serwisowa(Id_firma_serwisowa),
	Id_maszyny int NOT NULL FOREIGN KEY REFERENCES DP_Maszyna(Id_maszyny),
	Id_usluga_serwisu_zewnetrznego int NOT NULL FOREIGN KEY REFERENCES DP_Usluga_serwisu_zewnetrznego(Id_usluga_serwisu_zewnetrznego), 
...
CREATE TABLE DP_Serwis_wewnetrzny_naprawa(
	...
	Id_maszyny int NOT NULL FOREIGN KEY REFERENCES DP_Maszyna(Id_maszyny),
	Id_pracownik int NOT NULL FOREIGN KEY REFERENCES DZ_Pracownik(Id_pracownika),
	Data_rozpoczecia date NOT NULL,
	Data_zakonczenia date NULL,
...
CREATE TABLE DP_Serwis_wewnetrzny_obsluga(
	...
	Id_maszyny int NOT NULL FOREIGN KEY REFERENCES DP_Maszyna(Id_maszyny),
	Id_pracownik int NOT NULL FOREIGN KEY REFERENCES DZ_Pracownik(Id_pracownika),
	Id_czynnosc_w_ramach_obslugi_serw_wew int NOT NULL FOREIGN KEY REFERENCES DP_Czynnosc_w_ramach_obslugi_serw_wew(Id_czynnosc_w_ramach_obslugi_serw_wew),
	Data_rozpoczecia date NOT NULL,
	Data_zakonczenia date NULL
	);
CREATE TABLE DP_Narzedzie_uzyte_obsluga(
	Id_narzedzia int NOT NULL FOREIGN KEY REFERENCES DM_Narzedzie(Id_narzedzia),
    Id_serwis_wewnetrzny_obsluga int NOT NULL FOREIGN KEY REFERENCES DP_Serwis_wewnetrzny_obsluga(Id_serwis_wewnetrzny_obsluga)
	);
CREATE TABLE DP_Narzedzie_uzyte_naprawa(
	Id_narzedzia int NOT NULL FOREIGN KEY REFERENCES DM_Narzedzie(Id_narzedzia),
    Id_serwis_wewnetrzny_naprawa int NOT NULL FOREIGN KEY REFERENCES DP_Serwis_wewnetrzny_naprawa(Id_serwis_wewnetrzny_naprawa)
	);
