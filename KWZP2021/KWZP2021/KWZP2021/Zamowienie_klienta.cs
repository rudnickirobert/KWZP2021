...
namespace KWZP2021
{
    public partial class Zamowienie_klienta : Form
    {
        ...
        {
            DodajZamowienieKlienta dodaj_Zamowienie_Klienta = new DodajZamowienieKlienta(this.database);
        ...
        {
            SzczegolyZamowieniaKlienta szczegoly = new SzczegolyZamowieniaKlienta(this.database);
