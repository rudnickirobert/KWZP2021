...
namespace KWZP2021
{
    public partial class Edycja_parametru_czesci : Form
    {
        ...
        /*private void button1_Click(object sender, EventArgs e)
        {
            ...
            int row = Convert.ToInt32(frm.dgvParametrCzesci.CurrentRow.Index);
            //DM_Parametr_czesci toUpdate = this.database.DM_Parametr_czesci.Where(czesc => czesc.Id_przypisania_parametru_czesci == row).First();
            toUpdate.Wartosc = textBox1.Text;


            database.SaveChanges();
            frm.dgvParametrCzesci.DataSource = this.database.DM_Parametr_czesci.ToList();
            this.Close();
        }*/
    }
}
